...
| `supplemental_data/` | **every input the figure scripts read**, 38.2 MB. Self-contained: all twenty-five figures rebuild from this directory alone. Documented file by file, column by column, in `supplemental_data/SUPPLEMENTAL_DATA_OVERVIEW.md` |
...
[`FIGURE_REPORT.md`](FIGURE_REPORT.md) presents all twenty-five figures with their
...
| `SUPP_FIG_XX_sid2_ortholog_conservation` | `SUPP_FIG_XX_sid2_ortholog_conservation.R` |
...
rebuilding: all twenty-five regenerate, with nothing extra.
