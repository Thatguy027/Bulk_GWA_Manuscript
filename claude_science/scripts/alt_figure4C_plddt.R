...
RES <- "claude_science/data/sid2_panelC_residues.tsv"
PUB <- "claude_science/data/sid2_panelC_published.tsv"
CARTOON <- "claude_science/plots/sid2_cartoon_plddt.png"
ZOOM <- "claude_science/plots/sid2_zoom_plddt.png"
...
ggsave(file.path(OUT, "Figure4C_rebuild.pdf"), fig, width = 12.2, height = 4.9,
       device = cairo_pdf)
ggsave(file.path(OUT, "Figure4C_rebuild.png"), fig, width = 12.2, height = 4.9,
       dpi = 300, bg = "white")
