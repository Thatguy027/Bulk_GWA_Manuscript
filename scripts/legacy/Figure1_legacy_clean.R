...
ggsave(slope_plot, filename = "plots/mip-nnls_comparison.pdf", height = 8, width = 10)
...
# Main figure 1 - Panel A only
library(patchwork)
slope_plot + plot_annotation(tag_levels = "A") & theme(plot.tag = element_text(size = 26))

ggsave(filename = "plots/figure1.pdf", height = 8, width = 10)
ggsave(filename = "plots/figure1.png", height = 8, width = 10)

# Panel B as supplemental
ds_cor + plot_annotation(tag_levels = list(c("B"))) & theme(plot.tag = element_text(size = 26))

ggsave(filename = "plots/figure1_supp.pdf", height = 8, width = 10)
ggsave(filename = "plots/figure1_supp.png", height = 8, width = 10)
