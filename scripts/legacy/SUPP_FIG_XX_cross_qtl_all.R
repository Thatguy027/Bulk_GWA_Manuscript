## Supplement -- every significant cross QTL ---------------------------------
## As Figure 2, but with every genome-wide significant cross QTL rather than
## only those with peak LOD > 100.
##
##   Rscript scripts/pooled_cross_intersection_prep.R   # once, builds the cache
##   Rscript scripts/SUPP_FIG_XX_cross_qtl_all.R
## ---------------------------------------------------------------------------
...
## ---------------------------------------------------------------------------
build(b$CROSS_THR, "SUPP_FIG_XX_cross_qtl_all", c(10, 100, 300, 600, 900))
