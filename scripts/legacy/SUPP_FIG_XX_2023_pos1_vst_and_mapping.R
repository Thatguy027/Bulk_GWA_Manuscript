## SUPP_FIG_XX_2023_pos1_vst_and_mapping -- SUPERSEDED -----------------------
## The 2023 pos-1 vst phenotype distribution and its association scan.
##
##   Rscript scripts/legacy/SUPP_FIG_XX_2023_pos1_vst_and_mapping.R
##     -> plots/legacy/SUPP_FIG_XX_2023_pos1_vst_and_mapping.{pdf,png}
##
## Superseded: these two panels became panels B and C of Figure1_pos1. Kept
## because the standalone version carries its own titles and subtitles.
## Split out of the former scripts/2023_pos1_analysis.R; the replicate figure
## from that file is now
