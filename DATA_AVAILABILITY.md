...
twenty-one figures rebuild from it alone, verified by deleting `data/` and running
...
Since `supplemental_data/` is tracked, **all twenty-one figures now build from a
